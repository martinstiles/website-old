...
const TopBar = () => {
  ...
  const topbarColumn = {
    flex: '33%', maxWidth: '33%', fontSize: `calc(${0.5}em + ${0.5}vw)`, display: 'flex', textAlign: 'center' }
  ...
  const textRow = {
    flex: '50%', maxHeight: '50%', margin: '0'
  }

  const iconStyle = { width: `calc(${1}em + ${1}vw)`, height: `calc(${1}em + ${1}vw)`}
